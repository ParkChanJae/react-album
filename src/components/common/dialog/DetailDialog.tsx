            ...
            <div className={styles.container__dialog}>
                <div className={styles.container__dialog__header}>
                    <div className={styles.close}>
                        <button className={styles.close__button}>{/*구글 아이콘*/}</button>
                        <img src="" alt="사진작가 프로필" className={styles.close__authorImage} />
                        <span className={styles.close__authorName}>ChanJae</span>
                    </div>
                    <div className={styles.bookmark}>
                        <button className={styles.bookmark__button}>{/* 구글아이콘 */}북마크</button>
